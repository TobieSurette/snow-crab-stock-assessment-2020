...
catch(s) <- catch(b, category = categories, weight = TRUE, hard.shelled = TRUE, units = "t") # Merge catches.
...
catch(ss) <- catch(bb, category = categories, weight = TRUE, hard.shelled = TRUE, units = "t")
