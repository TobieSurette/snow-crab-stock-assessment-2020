...
gdevice("pdf", file = paste0("programs/recruitment/Bayesian Recruitment Model Figure - ", language), width = 8.5, height = 10)

m <- kronecker(matrix(1:4), matrix(1, nrow = 4, ncol = 7))
m <- rbind(0, cbind(0, m, 0), 0, 0)
layout(m)
par(mar = c(0, 0, 0, 0))
xlim <- c(1993.5, 2023.5)
for (i in 1:4){
   ylab <- paste0("R", i)
   if (i == 1){
      ylim <- c(0, 120)
...
axis(1, at = seq(1994, 2023, 4), cex.lab = 1.35)
axis(1, at = seq(1996, 2023, 2), cex.lab = 1.35)
